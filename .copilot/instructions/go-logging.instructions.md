...
If a log sink fails, this project must continue running. Never `log.Fatal` or `os.Exit` on a write error. Emit a warning through any remaining sink and carry on.
