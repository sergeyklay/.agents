...
sync_settings() {
  ...
  for_host codex ensure_subdir "$HOME/.codex" mcp
  for_host codex sync_to "$REPO_ROOT/.codex/mcp/bpdb" "$HOME/.codex/mcp/bpdb"
  for_host codex sync_to "$REPO_ROOT/mcps/postgres.ts" "$HOME/.codex/mcp/bpdb/postgres.ts"
