...
- Read the project's context files (`AGENTS.md`, `CONTRIBUTING.md`, `README.md`), and project architecture documentation so you know the coding standards, verification commands, issue tracker.
