...
- **Load the skill before reading the user's question a second time.** Do not paraphrase from memory, do not "apply the spirit of" it. Read the actual skills first.
