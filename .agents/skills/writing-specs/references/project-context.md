...
1. **Project-level agent instructions**: `AGENTS.md`. These yield boundary rules; read it when the project ships it and quote the rules that constrain the feature.
