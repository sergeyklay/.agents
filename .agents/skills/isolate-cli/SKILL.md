...
One tool, one version, as an illustration of the shape above, worked through Gemini CLI 0.40.x on Linux: see [references/worked-example.md](references/worked-example.md).
